        ...
        <header className="mb-8 sm:mb-10 md:mb-12">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 backdrop-blur-sm bg-black/20 rounded-2xl p-3 sm:p-4 border border-cyan-500/10 gap-4 sm:gap-0">
            ...
            <nav className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
              <a href="#" className="text-cyan-400 hover:text-cyan-300 font-medium px-4 py-2 rounded-lg hover:bg-cyan-950/30 transition-all border border-cyan-500/20 hover:border-cyan-400/50 backdrop-blur hover:scale-105 hover:shadow-lg text-center">
                Dashboard
              </a>
              <a href="#" className="text-gray-400 hover:text-cyan-300 font-medium px-4 py-2 rounded-lg hover:bg-cyan-950/30 transition-all border border-slate-500/20 hover:border-cyan-400/50 hover:scale-105 hover:shadow-lg text-center">
                Devices
              </a>
              <a href="#" className="text-gray-400 hover:text-cyan-300 font-medium px-4 py-2 rounded-lg hover:bg-cyan-950/30 transition-all border border-slate-500/20 hover:border-cyan-400/50 hover:scale-105 hover:shadow-lg text-center">
                Settings
              ...
              <button className="bg-cyan-500/20 text-cyan-300 font-medium px-6 py-2 rounded-lg hover:bg-cyan-500 hover:text-black transition-all border border-cyan-500/50 hover:scale-105 hover:shadow-lg flex items-center gap-2 justify-center">
                + Add Device
              </button>
              <button className="bg-black/40 text-cyan-300 font-medium px-4 py-2 rounded-lg hover:bg-cyan-950/50 transition-all border border-cyan-500/20 hover:border-cyan-400/50 hover:scale-105 hover:shadow-lg flex items-center gap-2 justify-center">
          ...
          <div className="bg-black/40 rounded-2xl p-4 sm:p-6 backdrop-blur-md border border-cyan-500/10 relative">
            ...
            <div className="relative h-48 sm:h-[300px] w-full flex justify-center items-center">
              ...
              <Image
                ...
                width={350}
                height={225}
                className="rounded-xl shadow-2xl object-contain relative z-10 max-w-full h-auto"
              />
            </div>
